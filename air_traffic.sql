...
(
  ...
  seat_id INTEGER REFERENCES seat_charts NOT NULL,
  flight_code INTEGER REFERENCES flights NOT NULL,
  airline_id INTEGER REFERENCES airlines NOT NULL,
  from_city INTEGER REFERENCES cities NOT NULL,
  from_country INTEGER REFERENCES countires NOT NULL,
  to_city INTEGER REFERENCES cities NOT NULL,
  to_country INTEGER REFERENCES countires NOT NULL
)
INSERT INTO tickets
